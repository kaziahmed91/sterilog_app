                ...
                <div class="card-body">
                    <form role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label text-lg-right">Company Identifier</label>

                            <div class="col-lg-6">
                                <input
                                        type="text"
                                        class="form-control{{ $errors->has('public_id') ? ' is-invalid' : '' }}"
                                        name="public_id"
                                        value="{{ old('public_id') }}"
                                        required
                                >
                                @if ($errors->has('public_id'))
                                    <div class="invalid-feedback">
                                        <strong>{{ $errors->first('public_id') }}</strong>
                                    </div>
                                @endif
                            </div>
                        </div>
